...
function init() {
    ...
    const material = new THREE.MeshPhongMaterial( { color: 0x3a6186, flatShading: true } );
    ...
    const ground = new THREE.MeshPhongMaterial( { color: 0x0d1b2a, flatShading: true } );
    ...
    // NEW SHAPE
    const torusGeometry = new THREE.TorusGeometry( 40, 10, 8, 24 );
    const torusMaterial = new THREE.MeshPhongMaterial( { color: 0xe8a838, flatShading: true } );
    const torus = new THREE.Mesh( torusGeometry, torusMaterial );
    torus.position.set( 0, 80, 0 );
    scene.add( torus );
